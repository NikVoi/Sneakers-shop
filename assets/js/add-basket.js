            ...
            <div class="line"></div>
                <div class="basket__product" data-id = "${productInfo.id}">
                    ...
                    <div class="basket__right">   
                        <div class="basket__title">${productInfo.title}</div>
                        
                        <div class="basket__block"> <p>Количесво: </p>
                            <div class="card__button-count" data-counter__modal> ${productInfo.counter}</div>
                        </div>
                    
                        <div class="basket__price">Цена: <p class = "basket__price-inf"> ${productInfo.price} </p></div>
    
                        <div class="baskrt__color">Цвет: <div class="blok__color"></div></div>
    
                        <div class="baskrt__size">Размер: <p> ${productInfo.size} </p> </div>
