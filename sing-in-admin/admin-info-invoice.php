    ...
    <section class="product">
       <table>
        ...
        <?php
             ...
             $products = mysqli_query($connect, "SELECT * FROM Select_invoice");
             ...
             { ?>
               <tr>
                   ...
                   <td> <a style="color: red;" href="/assets/php/delete-invoice.php?id=<?= $product[0] ?>"> Удалить </a></td>
               </tr>
             <?php 
             } 
         ?>
