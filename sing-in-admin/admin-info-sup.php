  ...
  <body >
    ...
    <section class="product">
       <table>
           <tr>
               <th>id</th>
               <th>Full_name_supplier</th>
               <th>Legal_address_supplier</th>
               <th>supplier_account_number</th>
               <th>product_name</th>
               <th>product_price</th>
               <th>Edit</th>
               <th>Delete</th>
        ...
        <?php
             ...
             $products = mysqli_query($connect, "SELECT * FROM selectsupplier");
             ...
             { ?>
               <tr>
                   ...
                   <td> <a style = "color: red;" href="/sing-in-admin/delete-sup.php?id=<?=$product[0]?>"> Удалить </a></td>
               </tr>
             <?php 
             } 
         ?>
