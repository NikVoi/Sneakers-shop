<?php
    ...
    $product = mysqli_query($connect, "SELECT * FROM select_product WHERE `Id_product` = '$product_id'");
...
<html lang="ru">
  <head>
    ...
    <title>Админ панель | Редактирование товара</title>
  </head>
        ...
        <div class="container-sm">
            <form action="../assets/php/update.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="formGroupExampleInput"  name = "Product_name" value="<?= $product['Product_name']?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label"  >Введите цену товара</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2"  name = "Product_price" value="<?= $product['Price']?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Введите размер товара</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2"   name = "Product_size" value="<?= $product['Product_size']?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label"  >Введите изготовителя товара</label>
                    <input type="text" class="form-control" id="formGroupExampleInput"  name = "Product_manufacturer" value="<?= $product['Product_Manufacture']?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label" >Введите цвет товара (На английском!)</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2"   name = "Product_color" value="<?= $product['Product_color']?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label" >Введите количество товаров</label>
                    <input type="textarea" class="form-control" id="formGroupExampleInput"   name = "Product_count" value="<?= $product['Product_count']?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label"  >Введите описание товара (Можно не заполнять)</label>
                    <textarea type="text" class="form-control" id="formGroupExampleInput2"  name = "Product_description"><?= $product['Product_description']?></textarea>
                </div>
                <div class="md-3">
                    <label for="formGroupExampleInput2" class="form-label">Добавте картинку к товару</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" name = "Product_img" value="<?= $product['Product_img']?>">
                </div>
