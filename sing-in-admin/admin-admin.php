...
<html lang="ru">
  ...
  <body >
    ...
    <div class="container gx-5">
      <a class="btn btn-primary w-100" href="../sing-in-admin/admin-add-product.php" role="button">Добавить товар</a>
      <a class="btn btn-primary w-100" href="../sing-in-admin/admin-updeate.php" role="button">Информация о товар</a>
      <a class="btn btn-primary w-100" href="../sing-in-admin/admin-info-sup.php" role="button">Информация о Поставщиков</a>
      <a class="btn btn-primary w-100" href="../sing-in-admin/admin-info-personal.php" role="button">Информация о Сотрудников</a>
      <a class="btn btn-primary w-100" href="../sing-in-admin/admin-info-invoice.php" role="button">Информация о Счетов</a>
      <a class="btn btn-primary w-100" href="../sing-in-admin/admin-info-order.php" role="button">Информация о заказов</a>
    </div>
