...
<html lang="ru">
  <head>
    ...
    <title>Sneakers Shop | Запрос № 5</title>
  </head>
  ...
  <header class="header">
    ...
    <label for="formGroupExampleInput" class="form-label" >Определить название фирмы, должность и оклад данного сотрудника.</label>
        <form action="../assets/php/select_5.php" method="POST" target="_balank">
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label" >Введите Ф.И.О Сотрудника</label>
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Введите название фирмы" name = "Full_name_employee">
                </div>
