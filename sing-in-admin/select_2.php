...
<html lang="ru">
  <head>
    ...
    <title>Sneakers Shop | Запрос № 2</title>
  </head>
  ...
  <header class="header">
    ...
    <label for="formGroupExampleInput" class="form-label" >Перечислить номера заказов и ФИО клиентов, которые заказали данный товар, в данном количестве</label>
        <form action="../assets/php/select_2.php" method="POST" target="_balank">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Введите количество заказаных товаров</label>
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Введите количество заказаных товаров" name = "Quantity">
                </div>
